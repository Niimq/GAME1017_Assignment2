...
const float PlatformPlayer::s_kJumpForce = 350;
const float PlatformPlayer::s_kMaxVelocityX = 350;
const float PlatformPlayer::s_kMaxVelocityY = 350;
...
void PlatformPlayer::Update(float deltaTime)
{
	...
	case PlayerState::kRunning:
		...
		else if (EventManager::KeyHeld(SDL_SCANCODE_D) && m_destinationTransform.x < 1024 - m_destinationTransform.w)
		{
			m_accelX = s_kAccelerationX;
		}
		// Transition to jump.
